<template>
	<div class="fixed-more-icon" @click="toggleDropdown">
		<el-icon size="23px">
			<svg fill="none" stroke-width="0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
				class="toolbar-toggle hope-icon hope-c-XNyZK hope-c-PJLV hope-c-PJLV-ifkxHPo-css" height="1em" width="1em"
				style="overflow: visible;">
				<path fill="currentColor"
					d="M7 14a2 2 0 100-4 2 2 0 000 4zM14 12a2 2 0 11-4 0 2 2 0 014 0zM17 14a2 2 0 100-4 2 2 0 000 4z"></path>
	...
	<div v-if="isDropdownVisible" class="custom-dropdown">
		<!-- 基础设置 -->
		<!-- <BasicSetting>
            <el-tooltip class="box-item" content="Basic setting 基础设置" placement="left">
		...
		<MergeDelete>
			<el-tooltip class="box-item" content="merge delete 合并删除文件" placement="left">
				<div class="dropdown-item">
					<el-icon size="23px">
						<Delete />
					</el-icon>
		...
		<!-- 创建文件夹 -->
		<CreateFolder>
			<el-tooltip class="box-item" content="create folder 创建文件夹" placement="left">
				<div class="dropdown-item">
					<el-icon size="23px">
						<FolderAdd />
					</el-icon>
...
import MergeDelete from '../util/MergeDelete.vue';
...
<style scoped>
/* 假设选择框的类名是 .el-table-column--selection */
...
.fixed-more-icon {
	...
	/* 悬停效果 */
	border-radius: 5px;
	color: rgb(215, 164, 249);
}

.fixed-more-icon:hover {
	background: #b86ef9;
	border-radius: 5px;
}
