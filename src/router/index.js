...
import RolePermissions from '@/admin_page/RolePermissions.vue';
...
const routes = [
  ...
  { path: '/admin/permission', component: RolePermissions, meta: { requiresAuth: true } },
  { path: '/admin/role', component: UserRole, meta: { requiresAuth: true } },
